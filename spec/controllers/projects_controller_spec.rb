	...
	describe "/projects/:name/activities" do
		...
		context 'bitlyが有効なとき' do
			...
			context 'コメントが付けられたとき' do
				specify do
					expect_shout @project.irc_channel, '3Keita Urashima0 added comment: "テステス" - http://bit.ly/c6rPQs'
        ...
        <note>
          ...
          <text>&#12486;&#12473;&#12486;&#12473;</text>
			...
			context '複数のストーリーが削除されたとき' do
				specify do
					expect_shout @project.irc_channel, '3Keita Urashima0 deleted 2 stories - http://bit.ly/an4B8S http://bit.ly/aFKp0d'
    ...
    <story>
      ...
      <url>https://www.pivotaltracker.com/services/v3/projects/3574/stories/3138007</url>
			...
			context 'ストーリーの description を変更したとき' do
				specify do
					expect_shout @project.irc_channel, '3Keita Urashima0 edited "pivotterをアナウンスする" - http://bit.ly/bLveRG'
...
README&#12434;&#26360;&#12367; (&#33521;&#35486;&#12391;)</description>
		...
		context 'bitlyが無効なとき' do
			...
			specify do
				expect_shout @project.irc_channel, '3Keita Urashima0 added comment: "テステス" - http://www.pivotaltracker.com/story/show/2809938'
